...
@Schema(name = "AnswerOutput", description = "Represents the answer data for the questions")
...
public class AnswerOutput {
  ...
  public AnswerOutput id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public AnswerOutput answer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  */
  ...
  public AnswerOutput severity(SeverityEnum severity) {
  ...
  */
  ...
  public AnswerOutput weight(WeightEnum weight) {
    this.weight = weight;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    AnswerOutput answerOutput = (AnswerOutput) o;
    return Objects.equals(this.id, answerOutput.id) &&
        Objects.equals(this.answer, answerOutput.answer) &&
        Objects.equals(this.severity, answerOutput.severity) &&
        Objects.equals(this.weight, answerOutput.weight);
  }
